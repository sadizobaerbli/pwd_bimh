              ...
              children: [
                Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Reported By', style: boldText(16.sp),),
                      ...
                      Row(
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: List.generate(
                            radioButtons.length, (index) => Padding(
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: List.generate(
                            radioButtons1.length, (index) => Padding(
                            padding: EdgeInsets.only(bottom: 4.h),
                            child: Row(
                              children: [
                                SizedBox(
                ...
                CustomDropDown(
                  ...
                  dropdownButtons: const["President's Office",
